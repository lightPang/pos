...
var confirmOutUrl = rootUrl + "Maintain/confirmOut";
var confirmReceiveUrl = rootUrl + "Maintain/confirmReceive";
  ...
  $.ajax({
    ...
    success:function(data){
      ...
      for( var i = 0; i < dataArr.length; ++i ){
        ...
        if( arrIndex != -1 || item['maintain_type'] == '1' )
