...
var createUrl =  rootUrl + "Operation/createMccSub";
var updateUrl = rootUrl + "Operation/updateMccSub";
var delUrl = rootUrl + "Operation/delMccSub";
var dataUrl = rootUrl + "Operation/getMccSubData";
...
function updateRow(ele){
  ...
  var mb_id = $tdlist.get(2);
  var remark = $tdlist.get(3);
  console.log(u_id);
  $("#ms_id").val( $(u_id).html() );
  $("#updateMccBig").val( $(mb_id).html() );
