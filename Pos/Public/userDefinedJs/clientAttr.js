...
var createUrl =  rootUrl + "Operation/createClientAttr";
var updateUrl = rootUrl + "Operation/updateClientAttr";
var delUrl = rootUrl + "Operation/delClientAttr";
var dataUrl = rootUrl + "Operation/getClientAttrData";
...
function updateRow( ca_id ){
  ...
  $.ajax({
    ...
    success : function( data ){
      ...
      $("#item_id").val( item['ca_id'] );
      loadModifyRecord();
    }
  });
}

function deleteRow( ca_id, ele){
  ...
  $.ajax({
    ...
    success: function( data){
      ...
      for( var i=0; i<dataArr.length; ++i ){
        ...
        row.push( editHtml + item['ca_id'] + editHtmlEnd + delHtml + item['ca_id'] + delHtmlEnd );
        rows.push(row);
      }
      var oTable1;
